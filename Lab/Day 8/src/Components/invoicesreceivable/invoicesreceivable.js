...
class InvoicesReceivable extends Component {
  render() {
  ...
  getTemplate() {
    return (
      <div className='invoicesreceivable'>
        <Row gutter={5}>
          <Col span={24}>
            <div className="add2cart-sctitle">Invoices - Receivable</div>
          </Col>
        </Row>
        <Row gutter={5}>
          <Col span={24}>
            <center>
              <h1>Invoices - Receivable</h1>
            </center>
            <br /><br />
          </Col>
        </Row>
...
export default InvoicesReceivable;